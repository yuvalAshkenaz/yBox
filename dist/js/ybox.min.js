...
Y=x.getBoundingClientRect(),f=Y.left,m=Y.top,d=x.clientHeight,b=x.clientWidth,v=c.clientHeight,p=c.clientWidth,g=parseFloat(c.getAttribute(K)),B=parseFloat(c.getAttribute(V)),h=ybox_minMax(parseFloat(c.getAttribute(G)),z,X),oe=0,ee=!0}function s(e){if(!0===re||!1===ee)return!1
M=e.clientX,H=e.clientY,I=h,C=(p*I-b)/2,F=(v*I-d)/2,W=p*I<=b?0:ybox_minMax(M-(j-g),-1*C,C),k=v*I<=d?0:ybox_minMax(H-(Q-B),-1*F,F),oe++,Math.abs(W)===Math.abs(C)&&(g=W,j=M),Math.abs(k)===Math.abs(F)&&(B=k,Q=H),c.setAttribute(G,I),c.setAttribute(K,W),c.setAttribute(V,k),ybox_moveScaleElement(c,W+"px",k+"px",I)}function n(){if(!0===re||!1===ee)return!1
ee=!1}function l(e){if(e.preventDefault(),e.touches.length>2)return!1
if(x=this,c=this.children[0],Y=x.getBoundingClientRect(),f=Y.left,m=Y.top,d=x.clientHeight,b=x.clientWidth,v=c.clientHeight,p=c.clientWidth,j=e.touches[0].clientX,Q=e.touches[0].clientY,h=ybox_minMax(parseFloat(c.getAttribute(G)),z,X),1===(N=e.touches.length)){if(null===se[0])se[0]=e.target,se[1]=j,se[2]=Q,setTimeout(function(){se=[null]},300)
...
g=parseFloat(c.getAttribute(K)),B=parseFloat(c.getAttribute(V))}else 2===N&&(g=parseFloat(c.getAttribute(K)),B=parseFloat(c.getAttribute(V)),w=e.touches[1].clientX,A=e.touches[1].clientY,E=(j+w)/2,L=(Q+A)/2,_=Math.sqrt((j-w)*(j-w)+(Q-A)*(Q-A)))
ae=0,ee=!0}function i(e){if(!1===ee)return!1
e.preventDefault(),M=e.touches[0].clientX,H=e.touches[0].clientY,N=e.touches.length,ae++,N>1?(O=e.touches[1].clientX,P=e.touches[1].clientY,T=Math.sqrt((M-O)*(M-O)+(H-P)*(H-P)),null===_&&(_=T),Math.abs(_-T)>=1&&(I=ybox_minMax(T/_*h,z,X),C=(p*I-b)/2,F=(v*I-d)/2,D=I-h,W=p*I<=b?0:ybox_minMax(g-(E-f-b/2-g)/(I-D)*D,-1*C,C),k=v*I<=d?0:ybox_minMax(B-(L-m-d/2-B)/(I-D)*D,-1*F,F),I>1?ybox_addClass(x,U):ybox_removeClass(x,U),ybox_moveScaleElement(c,W+"px",k+"px",I),_=T,h=I,g=W,B=k)):(I=h,C=(p*I-b)/2,F=(v*I-d)/2,W=p*I<=b?0:ybox_minMax(M-(j-g),-1*C,C),k=v*I<=d?0:ybox_minMax(H-(Q-B),-1*F,F),Math.abs(W)===Math.abs(C)&&(g=W,j=M),Math.abs(k)===Math.abs(F)&&(B=k,Q=H),c.setAttribute(G,h),c.setAttribute(K,W),c.setAttribute(V,k),ybox_moveScaleElement(c,W+"px",k+"px",I))}function u(e){if(N=e.touches.length,!1===ee)return!1
0===N?(c.setAttribute(G,h),c.setAttribute(K,W),c.setAttribute(V,k),_=null,ee=!1):1===N?(j=e.touches[0].clientX,Q=e.touches[0].clientY):N>1&&(_=null)}function y(e){if(x=this,c=this.children[0],Y=x.getBoundingClientRect(),d=x.clientHeight,b=x.clientWidth,v=c.clientHeight,p=c.clientWidth,f=Y.left,m=Y.top,h=ybox_minMax(parseFloat(c.getAttribute(G),z,X)),g=parseFloat(c.getAttribute(K)),B=parseFloat(c.getAttribute(V)),M=e.clientX,H=e.clientY,S=e.deltaY<0?1:-1,D=q*S,(I=h+D)<z||I>X)return!1
C=(p*I-b)/2,F=(v*I-d)/2,I<=1?(W=0,k=0):(W=p*I<=b?0:ybox_minMax(g-(M-f-b/2-g)/(I-D)*D,-1*C,C),k=v*I<=d?0:ybox_minMax(B-(H-m-d/2-B)/(I-D)*D,-1*F,F)),I>1?ybox_addClass(x,U):ybox_removeClass(x,U),c.setAttribute(G,I),c.setAttribute(K,W),c.setAttribute(V,k),ybox_moveScaleElement(c,W+"px",k+"px",I)}e=void 0!==e&&Object.keys(e).length?e:{},t=void 0!==t&&Object.keys(t).length?t:{}
for(var x,c,d,b,f,m,h,v,p,g,B,_,j,w,Q,A,C,F,Y,E,L,M,O,H,P,S,D,W,k,T,I,N,R=t.scaleDefault||2,q=t.scaleDifference||.5,X=t.scaleMax||10,z=t.scaleMin||1,U=e.active||"active",G="data-scale",K="data-translate-x",V="data-translate-y",Z=e.transition||"transition",$=e.visible||"visible",J=document.getElementsByClassName(e.zoom||"zoom"),ee=!1,te=[null],oe=0,re=!1,ae=0,se=[null],ne=0;ne<J.length;ne++)x=J[ne],c=x.children[0],c.setAttribute(G,1),c.setAttribute(K,0),c.setAttribute(V,0)
window.addEventListener("load",function(){for(var e=0;e<J.length;e++)x=J[e],c=x.children[0],ybox_addClass(c,$)
window.addEventListener("resize",function(){for(var e=0;e<J.length;e++)x=J[e],c=x.children[0],!1!==ybox_hasClass(x,U)&&(d=x.clientHeight,b=x.clientWidth,v=c.clientHeight,p=c.clientWidth,g=parseFloat(c.getAttribute(K)),B=parseFloat(c.getAttribute(V)),I=R,C=(p*I-b)/2,F=(v*I-d)/2,W=p*I>b?ybox_minMax(g,-1*C,C):0,k=v*I>d?ybox_minMax(B,-1*F,F):0,1===I&&ybox_removeClass(x,U),c.setAttribute(G,I),c.setAttribute(K,W),c.setAttribute(V,k),ybox_moveScaleElement(c,W+"px",k+"px",I))})}),ybox_massAddEventListener(J,"mousedown",a),ybox_massAddEventListener(J,"mouseenter",o),ybox_massAddEventListener(J,"mouseleave",r),document.addEventListener("mousemove",s),document.addEventListener("mouseup",n),document.addEventListener("touchstart",function(){re=!0}),ybox_massAddEventListener(J,"touchstart",l),document.addEventListener("touchmove",i,{passive:!1}),document.addEventListener("touchend",u),ybox_massAddEventListener(J,"wheel",y)}function ybox_addClass(e,t){!1===ybox_hasClass(e,t)&&(e.className+=" "+t)}function ybox_disableScroll(e){e||(window.addEventListener&&window.addEventListener("DOMMouseScroll",ybox_preventDefault,!1),window.onwheel=ybox_preventDefault,window.onmousewheel=document.onmousewheel=ybox_preventDefault,window.ontouchmove=ybox_preventDefault),document.onkeydown=ybox_preventDefaultForScrollKeys}function ybox_enableScroll(){window.removeEventListener&&window.removeEventListener("DOMMouseScroll",ybox_preventDefault,!1),window.onmousewheel=document.onmousewheel=null,window.onwheel=null,window.ontouchmove=null,document.onkeydown=null}function ybox_isWithinRange(e,t,o){return e>=t&&e<=o}function ybox_hasClass(e,t){var o=new RegExp("(?:^|\\s)"+t+"(?!\\S)","g")
...
jQuery(".yBoxFrame").length?jQuery(".yBoxFrame.yBoxImgWrap").length?(remove_yBox_placeholder(),insert_yBox_html({self:e.self,hasSelf:o,url:e.url,code:e.code,focus:e.focus})):jQuery(".insertYboxAjaxHere").animate({opacity:0},function(){var t=jQuery(this)
...
return o&&jQuery('.yBox[data-ybox-group="'+o+'"]').length>1&&(t='<button type="button" class="yBoxNext" title="'+strings.next+'"></button>'+t+'<button type="button" class="yBoxPrev" title="'+strings.prev+'"></button>'),jQuery(".yBoxOverlay.active").length?(jQuery(".yBoxFrame").addClass("fade-out"),setTimeout(function(){jQuery(".insertYboxAjaxHere").html(t),setTimeout(function(){jQuery(".yBoxFrame").removeClass("fade-out")},50)},500)):jQuery(".insertYboxAjaxHere").html(t),t}function yBoxNext(e){var t,o=e.data("ybox-group"),r=!1
jQuery('.yBox[data-ybox-group="'+o+'"]:not(.swiper-slide-duplicate)').each(function(a){r||jQuery(this).attr("href")==e.attr("href")&&(r=!0,t=jQuery('.yBox[data-ybox-group="'+o+'"]:not(.swiper-slide-duplicate)').eq(a+1).length?jQuery('.yBox[data-ybox-group="'+o+'"]:not(.swiper-slide-duplicate)').eq(a+1):jQuery('.yBox[data-ybox-group="'+o+'"]:not(.swiper-slide-duplicate)').eq(0))}),t&&(jQuery(".yBox").data("focus",""),t.data("focus","yBoxNext"),t.trigger("click"))}function yBoxPrev(e){var t,o=e.data("ybox-group")
jQuery('.yBox[data-ybox-group="'+o+'"]:not(.swiper-slide-duplicate)').each(function(r){if(jQuery(this).attr("href")==e.attr("href"))if(jQuery('.yBox[data-ybox-group="'+o+'"]:not(.swiper-slide-duplicate)').eq(r-1).length)t=jQuery('.yBox[data-ybox-group="'+o+'"]:not(.swiper-slide-duplicate)').eq(r-1)
